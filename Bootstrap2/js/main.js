...
function addpoint() {
    ...
    var pointGeometry = new THREE.SphereGeometry(1, 16, 16), // adjust the first value for the 'point' radius
...
function add_ABCD(ph) {
    ...
    line_geometry.vertices.push(new THREE.Vector3(A_x, ph/2+1, A_y));
    line_geometry.vertices.push(new THREE.Vector3(D_x, ph/2+1, D_y));
...
function on() {
    ...
    //     if($(obj).is("#threejs_div, #threejs_div *")){
    //         alert("被点击");
    //     }else {
    //         alert("未被点击");
    //     }
    ...
    //     }
    // });
    // var event1 = $("#all_content").click(function(e) {
    //     e = window.event || e;
    //     obj = $(e.srcElement || e.target);
    //     if($(obj).is("#threejs_div, #threejs_div *") && $("#checkbox").prop("checked")){
    //         alert("被点击");
    ...
    var event2 = $("#all_content").mousemove(function(e){
        e = window.event || e;
        obj = $(e.srcElement || e.target);
        if($(obj).is("#threejs_div, #threejs_div *") && ($("#checkbox").prop("checked") == false)){
    ...
    var event3 = $("#all_content").mouseout(function(e){
        e = window.event || e;
        obj = $(e.srcElement || e.target);
        if($(obj).is("#threejs_div, #threejs_div *") && ($("#checkbox").prop("checked") == false)){
            console.log('can move');
    ...
    var event4 = $("#all_content").mouseup(function(e){
        e = window.event || e;
        obj = $(e.srcElement || e.target);
        if($(obj).is("#threejs_div, #threejs_div *") && ($("#checkbox").prop("checked") == false)){
            console.log('can move');
    ...
    var event5 = $("#all_content").mouseover(function(e){
        e = window.event || e;
        obj = $(e.srcElement || e.target);
        if($(obj).is("#threejs_div, #threejs_div *") && ($("#checkbox").prop("checked") == false)){
            console.log('can move');
